  ...
  return resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:40px 24px;">
        ...
        <a href="${APP_URL}/studio" style="display:inline-block;margin-top:20px;padding:12px 28px;background:#111;color:#fff;border-radius:10px;text-decoration:none;font-weight:700;">Start Separating →</a>
  ...
  return resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:40px 24px;">
        ...
        <a href="${APP_URL}/studio" style="display:inline-block;margin-top:20px;padding:12px 28px;background:#111;color:#fff;border-radius:10px;text-decoration:none;font-weight:700;">Open Studio →</a>
        <p style="margin-top:32px;font-size:13px;color:#999;">— The AudSep Team</p>
      </div>
    `,
  });
